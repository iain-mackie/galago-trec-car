...
//    }
  ...
  public String getHelpString() {
    return "galago build [flags] --indexPath=<index> (--inputPath+<input>)+\n\n"
            ...
            + "                           [default=false]\n"
            + "  --nonStemmedPostings={true|false}: Selects whether to build non-stemmed inverted indexes\n"
            + "                           [default=[true]]\n"
            + "  --stemmedPostings={true|false}: Selects whether to build stemmed inverted indexes\n"
            + "                           [default=[true]]\n"
